			...
			<div class="row">
				<div class="col-md-4 col-sm-4 col-4">
					<figure>
						...
						<img class="img-responsive"
							src="https://image.flaticon.com/icons/svg/748/748504.svg"
							width="300px">
					</figure>
				</div>
				...
				<div class="col-md-8 col-sm-8 col-8">
					...
					<div id="scroll">
						...
						<hr>
						<br> <strong>INFORMACIÓN RELEVANTE</strong> Es requisito
						necesario para la adquisición de los productos que se ofrecen en
						este sitio, que lea y acepte los siguientes Términos y
						...
						usted ha leído y aceptado los Términos y Condiciones de Uso en
						el presente documento. Todas los productos que son ofrecidos por
						...
						definición de una contraseña. <br> El usuario puede elegir
						y cambiar la clave para su acceso de administración de la cuenta
						en cualquier momento, en caso de que se haya registrado y que sea
						necesario para la compra de alguno de nuestros productos.
						ufpsgram.com.co no asume la responsabilidad en caso de que
						entregue dicha clave a terceros. <br> Todas las compras y
						transacciones que se lleven a cabo por medio de este sitio web,
						están sujetas a un proceso de confirmación y verificación, el
						cual podría incluir la verificación del stock y disponibilidad
						de producto, validación de la forma de pago, validación de la
						factura (en caso de existir) y el cumplimiento de las condiciones
						requeridas por el medio de pago seleccionado. En algunos casos
						puede que se requiera una verificación por medio de correo
						electrónico. <br> Los precios de los productos ofrecidos en
						esta Tienda Online es válido solamente en las compras realizadas
						en este sitio web. <br> <strong>LICENCIA</strong> <br> <strong>SHADIAGRAM</strong>
						...
						documento. <br> <strong>USO NO AUTORIZADO</strong> <br>
						...
						reventa de ningún tipo. <br> <strong>PROPIEDAD</strong> <br>
						...
						del uso o de la imposibilidad de utilizar nuestros productos. <br>
						<strong>POLÍTICA DE REEMBOLSO Y GARANTÍA</strong> <br> En
						el caso de productos que sean mercancías irrevocables
						...
						garantía no cubre averías o daños ocasionados por uso indebido.
						Los términos de la garantía están asociados a fallas de
						fabricación y funcionamiento en condiciones normales de los
						productos y sólo se harán efectivos estos términos si el equipo
						ha sido usado correctamente. Esto incluye: <br> – De
						acuerdo a las especificaciones técnicas indicadas para cada
						producto. – En condiciones ambientales acorde con las
						especificaciones indicadas por el fabricante. – En uso
						específico para la función con que fue diseñado de fábrica.
						– En condiciones de operación eléctricas acorde con las
						especificaciones y tolerancias indicadas. <br> <strong>COMPROBACIÓN
							ANTIFRAUDE</strong> <br> La compra del cliente puede ser aplazada
						para la comprobación antifraude. También puede ser suspendida
						por más tiempo para una investigación más rigurosa, para evitar
						transacciones fraudulentas. <br> <strong>PRIVACIDAD</strong>
						<br> Este sitio web shadiagram.com.co garantiza que la
						...
						judicial o requerimientos legales. <br> La suscripción a
						boletines de correos electrónicos publicitarios es voluntaria y
						podría ser seleccionada al momento de crear su cuenta. <br>
						<strong>SHADIAGRAM</strong> reserva los derechos de cambiar o de
						modificar estos términos sin previo aviso.
						</p>
						<!-- <div class="col md-12"> -->
						<button type="submit" class="btn btn-info" style="padding: 6px">
							Aceptar</button>
						<!-- </div> -->
					</div>
				</div>
